...
class Workspace(Base):
    ...
    judge_llm_provider_id    = Column(Integer, ForeignKey("llm_providers.id"), nullable=True)
    analysis_llm_provider_id = Column(Integer, ForeignKey("llm_providers.id"), nullable=True)
    utility_llm_provider_id  = Column(Integer, ForeignKey("llm_providers.id"), nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)
